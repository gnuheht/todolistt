...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ToastError = ({ msg }: { msg: String }) => {
  return (
...
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ToastInfo = ({ msg }: { msg: String }) => {
  return (
    <div className="bg-blue-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
      <svg
        viewBox="0 0 24 24"
      ...
      <span className="text-blue-800"> {msg} </span>
    </div>
  );
};
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ToastWarning = ({ msg }: { msg: String }) => {
  return (
    <div className="bg-orange-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
      ...
      <span className="text-yellow-800">{msg}</span>
    </div>
  );
};
