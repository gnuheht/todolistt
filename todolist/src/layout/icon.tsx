...
const ToastSuccess = () => {
  return (
    <div className="bg-green-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
      ...
      <span className="text-green-800">Thêm thành công</span>
    </div>
  );
};
// eslint-disable-next-line @typescript-eslint/no-explicit-any
const ToastError = () => {
  return (
    <div className="bg-red-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
      ...
      <span className="text-red-800"> Thêm không thành công </span>
    </div>
  );
};
// eslint-disable-next-line @typescript-eslint/no-explicit-any
...
const ToastWarning = () => {
  return (
    <div className="bg-orange-200 px-6 py-4 my-4 rounded-md text-lg flex items-center mx-auto max-w-lg">
      ...
      <span className="text-yellow-800">Công việc này bạn đã thêm rồi</span>
    </div>
  );
};
